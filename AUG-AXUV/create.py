...
def populate(download=True, repository_path=None, adas_path=None):
    ...
    rates = {
        ...
        'adf15': (
            ...
            (neon,      2, 'adf15/pec96#ne/pec96#ne_pju#ne2.dat'),
            (neon,      3, 'adf15/pec96#ne/pec96#ne_pju#ne3.dat'),
            (neon,      4, 'adf15/pec96#ne/pec96#ne_pju#ne4.dat'),
            (neon,      5, 'adf15/pec96#ne/pec96#ne_pju#ne5.dat'),
            (neon,      6, 'adf15/pec96#ne/pec96#ne_pju#ne6.dat'),
            (neon,      7, 'adf15/pec96#ne/pec96#ne_pju#ne7.dat'),
            (neon,      8, 'adf15/pec96#ne/pec96#ne_pju#ne8.dat'),
            (neon,      9, 'adf15/pec96#ne/pec96#ne_pju#ne9.dat'),
